export default function Footer() {
  ...
  return (
    ...
    <footer className="bg-gradient-to-b from-white to-rose-50 pb-20 sm:pb-0">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-rose-500">Apnadil</h3>
            <p className="text-gray-600">
              Creating beautiful moments for your loved ones, one surprise at a time.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-rose-100">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <p className="text-gray-600 text-sm">
              © {new Date().getFullYear()} Apnadil. Made with{' '}
              <span className="text-rose-500">♥</span> for your loved ones.
            </p>
          </div>
        </div>
        ...
        <div className="absolute inset-0 -z-10 opacity-5">
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl"></div>
          <div className="absolute bottom-0 right-0 w-64 h-64 bg-rose-300 rounded-full mix-blend-multiply filter blur-xl"></div>
        </div>
